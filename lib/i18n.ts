...
const ko = {
  ...
  "tag.emptyName": "운동 이름을 기입해주세요.",
  "tag.added": "운동이 추가되었습니다.",
  "tag.removed": "운동이 삭제 되었습니다.",
  "tag.removeTitle": "'{name}' 운동을 삭제 할까요?",
  "tag.removeDesc": "* 뭐 삭제하셔도 나중에 다시 추가 할 수 있어요.",
  "tag.editHint": "* 운동태그를 길게 누르면 수정모드로 변경됩니다",
  "tag.editDoneHint": "* 빈 화면을 누르면 수정모드가 종료됩니다",
...
const en: Record<TKey, string> = {
  ...
  "tag.emptyName": "Enter a workout name.",
  "tag.added": "Workout added.",
  "tag.removed": "Workout deleted.",
  "tag.removeTitle": "Delete '{name}'?",
  "tag.removeDesc": "* You can add it back later.",
  "tag.editHint": "* Long-press a workout tag to edit the list",
  "tag.editDoneHint": "* Tap an empty area to exit edit mode",
